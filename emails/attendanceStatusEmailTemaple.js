exports.attendanceStatusEmailTemplate = (data, status) => {
  // Ensure that status is defined and is a string to avoid errors
  const formattedStatus = status ? status.toLowerCase() : 'unknown';
        ...
        <div class="email-body">
          ...
          <div class="email-details">
            ...
            <table>
              <tr>
                <th>Status</th>
                <td><span class="status-badge status-${formattedStatus}">${
    status || 'Unknown'
  }</span></td>
              </tr>
              <tr>
