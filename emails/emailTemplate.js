function generateEmailTemplate(firstName, url, subject) {
  return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
        ...
        <div class="container">
            ...
            <div class="content">
                ...
                <div style="text-align: center; margin-top: 40px; margin-bottom: 40px;">
                    <a href="${url}" class="verify-button" style="display: inline-block; padding: 14px 30px; background-color: #4379F2; color: white; text-decoration: none; border-radius: 50px; font-size: 18px; font-weight: bold; box-shadow: 0 4px 15px rgba(67, 121, 242, 0.3);">Verify Email</a>
                </div>
